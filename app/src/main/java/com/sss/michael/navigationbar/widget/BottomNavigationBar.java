package com.sss.michael.navigationbar.widget;
...
import com.sss.michael.navigationbar.utils.AssetsUtil;
import com.sss.michael.navigationbar.utils.DensityUtil;
import com.sss.michael.navigationbar.utils.JsonUtils;
...
public class BottomNavigationBar extends View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            if (items.get(i).builder.bigImage) {
                ...
                //文字区域
                int[] size = getTextWH(items.get(i).getLabelPaint(textPaint), items.get(i).builder.label);
            ...
            if (items.get(i).builder.cornerMark != null && !"".equals(items.get(i).builder.cornerMark)) {
                int[] size = getTextWH(items.get(i).getCornerMarkPaint(cornerMarkPaint), items.get(i).builder.cornerMark);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < items.size(); i++) {
            ...
            if (items.get(i).builder.cornerMark != null && !"".equals(items.get(i).builder.cornerMark)) {
                ...
                int[] size = getTextWH(items.get(i).getLabelPaint(textPaint), items.get(i).builder.cornerMark);
                        ...
                        Glide.with(activity)
                                ...
                                .addListener(new RequestListener<GifDrawable>() {
                                    ...
                                    public boolean onLoadFailed(@Nullable GlideException e, Object model, Target<GifDrawable> target, boolean isFirstResource) {
                                        Log.e("SSSSS", url.toLowerCase().endsWith(".gif") + "");
                                        return false;
                                    }
    ...
    public static class Builder {
        ...
        public BottomNavigationBarItem build(AppCompatActivity context) {
            ...
            cornerMarkPaddingVertical = DensityUtil.dp2px(cornerMarkPaddingVertical > 0 ? cornerMarkPaddingVertical : 2);
            cornerMarkPaddingHorizontal = DensityUtil.dp2px(cornerMarkPaddingHorizontal > 0 ? cornerMarkPaddingHorizontal : 4);
